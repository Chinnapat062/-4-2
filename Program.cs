...
namespace การบ้านข้อ2ครั้ง4
{
    class Program
    {
        static void Main()
        {
            Console.WriteLine("Please Input your half DNA sequence");
        ...
        static string ReplicateSeqeunce(string halfDNASequence)
        {
            ...
            return result;
            Console.WriteLine("Replicate half DNA sequence :{0}", result);
        }
        static void IncorrectDNA(string halfDNASequence)
        {
            Console.WriteLine("Do you want to prcess another sequnece? (Y/N) :");
            char answer = char.Parse(Console.ReadLine());
            switch (answer)
            {
                case 'Y':
